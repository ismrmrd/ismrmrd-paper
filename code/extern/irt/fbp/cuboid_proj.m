...
proj = cuboid_proj_do(params, cg.s, cg.t, cg.ar, cg.source_zs, ...
...
% cuboid_proj_do()
function proj = cuboid_proj_do(params, ss, tt, ...
		beta, ... % [radians]
...
if oversample > 1
	...
	proj = cuboid_proj_do(params, ss(:), tt(:), beta, source_zs, dso, dod, dfs, 1);
